...
import { HardDrive, Usb, Play, CheckCircle, AlertTriangle, FileText, FolderOpen } from 'lucide-react';
    ...
    <div className="file-scanner">
      <div className="scanner-header">
        ...
        <div>
          ...
          <p>Analysez des images disques (.dd, .img, .raw) depuis une clé USB</p>
        </div>
      </div>
          ...
          <div className="usb-select-section">
            ...
            {usbDevices.length === 0 ? (
              <div className="no-usb">
                ...
                <span>Insérez une clé USB contenant l'image disque</span>
              </div>
            ) : (
            ...
            {loadingBrowser ? (
              ...
              <div className="file-list">
                {browserItems.length === 0 ? (
                  <p className="no-files">Aucun fichier .dd, .img, .raw ou .iso trouvé</p>
                ) : (
